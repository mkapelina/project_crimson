...
class UserHeader extends Component {
    ...
    render() {
        return (
            <div className="user-header">
                <button 
                    className="addProj-btn"
                    onClick={this.toggleAddProj.bind(this)}
                >+ New Project</button>
                {this.state.showAddProj && <AddProject 
    ...
    getUserProjects = props => {
        ...
        return (
            <tbody className="projects-list">
                ...
                <UncontrolledCollapse className="collapse" id="components" toggler="#toggler">
                        <tr>
